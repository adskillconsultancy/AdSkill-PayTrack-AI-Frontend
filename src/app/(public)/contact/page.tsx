            ...
            <div className="lg:col-span-5 space-y-6">
              ...
              <div className="space-y-4 text-xs">
                ...
                <div className="flex items-start gap-4 rounded-2xl border border-[#EAE6DF] bg-white p-5 shadow-xs">
                  <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-[#FAF8F5] text-[#0a0a0a] border border-[#EAE6DF]">
                    <Mail className="h-5 w-5 text-[#F3A712]" />
                  </div>
                  <div>
                    <div className="font-bold text-[#0a0a0a] text-sm">Official Billing & Inquiries</div>
                ...
                <div className="flex items-start gap-4 rounded-2xl border border-[#EAE6DF] bg-white p-5 shadow-xs">
                  ...
                  <div>
                    <div className="font-bold text-[#0a0a0a] text-sm">WhatsApp & Client Support</div>
                ...
                <div className="flex items-start gap-4 rounded-2xl border border-[#EAE6DF] bg-white p-5 shadow-xs">
                  ...
                  <div>
                    <div className="font-bold text-[#0a0a0a] text-sm">Advisory Hours</div>
              ...
              <div className="rounded-2xl border border-[#F3A712]/40 bg-[#FFFDF9] p-5 text-xs text-[#475569]">
                ...
                <p>
                  ...
                  <Link href={ROUTES.LOGIN} className="font-bold text-[#0a0a0a] underline hover:text-[#B47B00]">
                    Client Portal
                  </Link>.
                </p>
              </div>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div className="space-y-1.5">
                        ...
                        <Input
                          ...
                          className="h-10 rounded-xl border-[#EAE6DF] bg-[#FAF8F5] text-sm text-[#0a0a0a] placeholder:text-[#94A3B8]/60 placeholder:font-normal focus-visible:border-[#F3A712] focus-visible:ring-[#F3A712]"
                        />
                      </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      ...
                      <div className="space-y-1.5">
                        ...
                        <select
                          ...
                          className="w-full h-10 rounded-xl border border-[#EAE6DF] bg-[#FAF8F5] px-3.5 text-sm text-[#0a0a0a] focus:border-[#F3A712] focus:bg-white focus:outline-none"
                        >
                    ...
                    <div className="space-y-1.5">
                      ...
                      <textarea
                        ...
                        className="w-full rounded-xl border border-[#EAE6DF] bg-[#FAF8F5] px-3.5 py-2.5 text-sm text-[#0a0a0a] placeholder:text-[#94A3B8]/60 placeholder:font-normal focus:border-[#F3A712] focus:bg-white focus:outline-none"
                      />
                    </div>
